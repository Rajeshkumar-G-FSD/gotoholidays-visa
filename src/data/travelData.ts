...
// Shared image pool for hero + roadmap steps (all verified).
const IMG = {
  flight: U('photo-1436491865332-7a61a109cc05'),
  beach: U('photo-1507525428034-b723cf961d3e'),
  beach2: U('photo-1599325601183-042bed55081c'),
  water: U('photo-1544551763-46a013bb70d5'),
  resort: U('photo-1520250497591-112f2f40a3f4'),
  spa: U('photo-1540555700478-4be289fbecef'),
  dining: U('photo-1414235077428-338989a2e8c0'),
  drive: U('photo-1451337516015-6b6e9a44a8a3'),
  maldives: U('photo-1514282401047-d79a71a590e8'),
  dubai: U('photo-1512453979798-5ea266f8880c'),
  thailandBoat: U('photo-1552465011-b4e21bf6e79a'),
  bangkok: U('photo-1613672803979-a6edfc5a179b'),
  kl: U('photo-1596422846543-75c6fc197f07'),
  singapore: U('photo-1525625293386-3f8f99389edd'),
  lakshadweep: U('photo-1572431447238-425af66a273b'),
  sigiriya: U('photo-1612862862126-865765df2ded'),
  bali: U('photo-1537996194471-e657df975ab4'),
  kashmir: U('photo-1595815771614-ade9d652a65d'),
};

export const DESTINATION_PACKAGES: DestinationPackage[] = [
  {
    id: 'maldives',
    name: 'Maldives',
    flag: '🇲🇻',
    ...
    description:
      "Escape to the pristine paradise of the Maldives, where overwater bungalows, turquoise lagoons, and vibrant coral reefs await. Perfect for honeymooners, luxury travelers, and those seeking absolute serenity in one of the world's most exclusive destinations.",
    originalPrice: 20000,
    price: 14999,
    nights: 4,
    days: 5,
    ...
    currency: 'MVR',
    visa: 'On Arrival',
    heroImage: U('photo-1514282401047-d79a71a590e8', 2000, 1100),
    roadmap: [
      { day: 'Day 1', title: 'Seaplane to the Atoll', desc: 'Arrive at Malé, transfer by scenic seaplane and settle into your private overwater villa with a sunset welcome.', image: IMG.flight },
      { day: 'Day 2', title: 'House Reef & Sandbank', desc: 'Snorkel the coral house reef, then a private speedboat to a bare sandbank for a champagne picnic.', image: IMG.water },
      { day: 'Day 3', title: 'Spa Ritual & Dolphin Cruise', desc: 'Morning over-water spa ritual, followed by a golden-hour dolphin cruise across the lagoon.', image: IMG.spa },
      { day: 'Day 4', title: 'Private Beach Dinner', desc: 'A candle-lit dinner on the sand prepared by your island chef before a lazy final morning.', image: IMG.beach },
    ],
  },
  {
    id: 'dubai',
    ...
    description:
      'Skyscrapers, gold souks and red dunes in one glittering city. Dubai pairs record-breaking modern spectacle with old-Arabian charm, world-class dining and desert adventure — an easy, visa-simple long-weekend escape.',
    originalPrice: 18500,
    price: 12999,
    nights: 4,
    days: 5,
    ...
    currency: 'AED',
    visa: 'e-Visa',
    heroImage: U('photo-1512453979798-5ea266f8880c', 2000, 1100),
    roadmap: [
      { day: 'Day 1', title: 'Arrival & Marina Lights', desc: 'Check in downtown, then a Dubai Marina yacht cruise past the illuminated skyline.', image: IMG.flight },
      { day: 'Day 2', title: 'Burj Khalifa & Old Dubai', desc: 'Sunrise at the top of the Burj Khalifa, abra ride across the Creek and the gold & spice souks.', image: IMG.dubai },
      { day: 'Day 3', title: 'Red-Dune Desert Safari', desc: 'Dune bashing, camel ride and a Bedouin camp dinner under the stars.', image: IMG.drive },
      { day: 'Day 4', title: 'Fine Dining & Departure', desc: 'A tasting-menu dinner high above the city before your onward flight.', image: IMG.dining },
    ],
  },
  {
    id: 'thailand',
    name: 'Thailand',
    flag: '🇹🇭',
    tagline: 'Islands, Temples & Endless Smiles',
    description:
      'From the karst-studded Andaman Sea to Bangkok’s glittering temples and night markets, Thailand delivers beaches, culture and street food in one effortless, visa-free trip.',
    originalPrice: 19200,
    price: 12999,
    nights: 5,
    days: 6,
    ...
    currency: 'THB',
    visa: 'Visa Free',
    heroImage: U('photo-1552465011-b4e21bf6e79a', 2000, 1100),
    roadmap: [
      { day: 'Day 1', title: 'Bangkok by Night', desc: 'Land in Bangkok, tuk-tuk to a rooftop bar and a first taste of Jalan-style street food.', image: IMG.flight },
      { day: 'Day 2', title: 'Grand Palace & Wat Arun', desc: 'Temple morning along the Chao Phraya, then the flower market and a long-tail river cruise.', image: IMG.bangkok },
      { day: 'Day 3', title: 'Fly South to Krabi', desc: 'Short flight to the Andaman coast; sunset on Railay Beach framed by limestone cliffs.', image: IMG.thailandBoat },
      { day: 'Day 4', title: 'Phi Phi Island Hopping', desc: 'Private long-tail to Maya Bay, Pileh Lagoon and snorkelling stops over bright reefs.', image: IMG.water },
      { day: 'Day 5', title: 'Beach Day & Farewell Feast', desc: 'A slow beach day and a Royal Thai banquet before the return leg.', image: IMG.beach },
    ],
  },
  {
    id: 'malaysia',
    name: 'Malaysia',
    flag: '🇲🇾',
    tagline: 'Skylines, Rainforests & Island Calm',
    description:
      'Kuala Lumpur’s Twin Towers, hawker feasts and rainforest day-trips, with the option to unwind on Langkawi’s beaches. Big-city buzz and jungle quiet in one visa-free package.',
    originalPrice: 18000,
    price: 13499,
    nights: 4,
    days: 5,
    ...
    currency: 'MYR',
    visa: 'Visa Free',
    heroImage: U('photo-1596422846543-75c6fc197f07', 2000, 1100),
    roadmap: [
      { day: 'Day 1', title: 'Arrival in Kuala Lumpur', desc: 'Check in near KLCC and an evening at the Petronas Towers fountain show.', image: IMG.flight },
      { day: 'Day 2', title: 'City Icons & Jalan Alor', desc: 'Skybridge, Batu Caves rainbow steps and a hawker-stall dinner crawl.', image: IMG.kl },
      { day: 'Day 3', title: 'Rainforest & Fireflies', desc: 'Day trip to Kuala Selangor for a mangrove cruise and the fireflies at dusk.', image: IMG.drive },
      { day: 'Day 4', title: 'Spa & Departure', desc: 'A traditional Malay wellness ritual before your flight home.', image: IMG.spa },
    ],
  },
  {
    id: 'andaman',
    name: 'Andaman',
    flag: '🌴',
    tagline: "India's Untouched Emerald Isles",
    description:
      'Blue-Flag beaches, dawn elephant swims and beginner-friendly scuba on untouched reefs off Havelock and Neil Island — a domestic trip that feels a world away.',
    originalPrice: 14999,
    price: 10999,
    nights: 4,
    days: 5,
    bestTime: 'Oct – May',
    currency: 'INR',
    visa: 'Domestic (Permit)',
    heroImage: U('photo-1599325601183-042bed55081c', 2000, 1100),
    roadmap: [
      { day: 'Day 1', title: 'Port Blair & Cellular Jail', desc: 'Arrive in Port Blair; the Cellular Jail light-and-sound show in the evening.', image: IMG.flight },
      { day: 'Day 2', title: 'Ferry to Havelock', desc: 'Cruise to Swaraj Dweep and sunset at Blue-Flag Radhanagar Beach.', image: IMG.beach2 },
      { day: 'Day 3', title: 'Discover Scuba at Elephant Beach', desc: 'A guided first dive over shallow coral gardens, then a beach barbecue.', image: IMG.water },
      { day: 'Day 4', title: 'Neil Island & Bioluminescence', desc: 'Natural Bridge, glass-bottom boat and a night kayak through glowing plankton.', image: IMG.beach },
    ],
  },
  {
    id: 'singapore',
    name: 'Singapore',
    flag: '🇸🇬',
    tagline: 'A Garden City that Never Sleeps',
    description:
      'A continent of food, design and greenery on one island. Supertree light shows, hawker-centre Michelin meals and a SkyPark infinity edge above Marina Bay.',
    originalPrice: 19500,
    price: 13999,
    nights: 4,
    days: 5,
    ...
    currency: 'SGD',
    visa: 'e-Visa',
    heroImage: U('photo-1525625293386-3f8f99389edd', 2000, 1100),
    roadmap: [
      { day: 'Day 1', title: 'Marina Bay Arrival', desc: 'Check in at Marina Bay and catch the Spectra light-and-water show.', image: IMG.flight },
      { day: 'Day 2', title: 'Gardens by the Bay', desc: 'Cloud Forest, the OCBC Skyway and the Supertree Grove after dark.', image: IMG.singapore },
      { day: 'Day 3', title: 'Sentosa & Hawker Crawl', desc: 'Cable car to Sentosa, then chicken rice and chilli crab across three hawker centres.', image: IMG.dining },
      { day: 'Day 4', title: 'SkyPark & Departure', desc: 'A morning swim on the SkyPark infinity edge before your flight.', image: IMG.resort },
    ],
  },
  {
    id: 'lakshadweep',
    name: 'Lakshadweep',
    flag: '🌊',
    tagline: 'Coral Lagoons Few Ever See',
    description:
      'India’s best-kept secret — 36 permit-only coral atolls. Lagoon kayaking, reef snorkelling straight off the sand and nights with nothing but stars on Agatti and Bangaram.',
    originalPrice: 17500,
    price: 12499,
    nights: 3,
    days: 4,
    ...
    currency: 'INR',
    visa: 'Entry Permit',
    heroImage: U('photo-1572431447238-425af66a273b', 2000, 1100),
    roadmap: [
      { day: 'Day 1', title: 'Flight to Agatti', desc: 'Land on the reef-edge runway at Agatti and transfer by boat across the lagoon.', image: IMG.flight },
      { day: 'Day 2', title: 'Lagoon Snorkel & Kayak', desc: 'Glass-clear reef snorkelling off the beach and a slow kayak over the turquoise shallows.', image: IMG.water },
      { day: 'Day 3', title: 'Bangaram Sandbank Day', desc: 'Boat to uninhabited Bangaram for a castaway picnic and star-filled sky.', image: IMG.beach },
    ],
  },
  {
    id: 'srilanka',
    ...
    description:
      'Two thousand years of history over one small island — climb Sigiriya at sunrise, ride the misty hill-country train to Ella, safari for leopards in Yala and finish on the southern beaches.',
    originalPrice: 16000,
    price: 11999,
    nights: 5,
    days: 6,
    ...
    currency: 'LKR',
    visa: 'ETA Online',
    heroImage: U('photo-1612862862126-865765df2ded', 2000, 1100),
    roadmap: [
      { day: 'Day 1', title: 'Arrival & Cultural Triangle', desc: 'Land in Colombo and drive to Dambulla, gateway to the ancient kingdoms.', image: IMG.flight },
      { day: 'Day 2', title: 'Sunrise on Sigiriya', desc: 'Climb the Lion Rock fortress at dawn, then the Dambulla cave temples.', image: IMG.sigiriya },
      { day: 'Day 3', title: 'Kandy to Ella by Train', desc: 'The world’s most scenic rail journey through tea country to Ella.', image: IMG.drive },
      { day: 'Day 4', title: 'Yala Leopard Safari', desc: 'Dawn game drive in Yala National Park in search of leopard and elephant.', image: IMG.water },
      { day: 'Day 5', title: 'Southern Beaches', desc: 'Unwind in Mirissa — whale-watch by morning, beach by afternoon.', image: IMG.beach },
    ],
  },
];
